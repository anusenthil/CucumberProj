...
public class FirstPro {
	...
	public void user_provide_valid_in() {
	...
	@When("user provide valid input1")
	public void user_provide_valid_input1(io.cucumber.datatable.DataTable dataT) {
		List<String>onedimen = dataT.asList(String.class);
		 	driver.findElement(By.xpath("//label[text()='Done']")).click();
	...
	//<One Dimensional Map>
	@When("user provide valid input2")
	public void user_provide_valid_input2(io.cucumber.datatable.DataTable dataTable) {
